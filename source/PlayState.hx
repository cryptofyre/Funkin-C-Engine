...
class PlayState extends MusicBeatState
{
	...
	override public function create()
	{
		...
		else if (SONG.song.toLowerCase() == 'pico' || SONG.song.toLowerCase() == 'blammed' || SONG.song.toLowerCase() == 'philly')
		{
			...
			city.setGraphicSize(Std.int(city.width * 1.275));
			city.updateHitbox();
			...
			for (i in 0...5)
			{
				...
				light.visible = false;
				light.setGraphicSize(Std.int(light.width * 1.275));
				light.updateHitbox();
			...
			streetBehind.setGraphicSize(Std.int(streetBehind.width * 1.5));
		...
		else if (SONG.song.toLowerCase() == 'milf' || SONG.song.toLowerCase() == 'satin-panties' || SONG.song.toLowerCase() == 'high')
		{
			...
			var bgLimo:FlxSprite = new FlxSprite(-250, 710);
			...
			for (i in 0...5)
			{
				var dancer:BackgroundDancer = new BackgroundDancer((370 * i) + 130, bgLimo.y - 450);
				dancer.scrollFactor.set(0.4, 0.4);
				grpLimoDancers.add(dancer);
			}

			var overlayShit:FlxSprite = new FlxSprite(-500, -600).loadGraphic(Paths.image('limo/limoOverlay'));
			overlayShit.setGraphicSize(Std.int(overlayShit.width * 1.5));
			...
			limo = new FlxSprite(-10, 600);
			limo.setGraphicSize(Std.int(limo.width * 1.5));
			limo.frames = limoTex;
			...
			fastCar.setGraphicSize(Std.int(fastCar.width * 1.5));
			// add(limo);
		}
		else if (SONG.song.toLowerCase() == 'cocoa' || SONG.song.toLowerCase() == 'eggnog')
		{
			...
			var bg:FlxSprite = new FlxSprite(-1500, -750).loadGraphic(Paths.image('christmas/bgWalls'));
			bg.antialiasing = true;
			...
			upperBoppers = new FlxSprite(-360, -195);
			upperBoppers.frames = Paths.getSparrowAtlas('christmas/upperBop');
			upperBoppers.animation.addByPrefix('bop', "Upper Crowd Bob", 24, false);
			upperBoppers.antialiasing = true;
			upperBoppers.scrollFactor.set(0.33, 0.33);
			upperBoppers.setGraphicSize(Std.int(upperBoppers.width * 1.275));
			upperBoppers.updateHitbox();
			add(upperBoppers);

			var bgEscalator:FlxSprite = new FlxSprite(-1650, -900).loadGraphic(Paths.image('christmas/bgEscalator'));
			bgEscalator.antialiasing = true;
			bgEscalator.scrollFactor.set(0.3, 0.3);
			bgEscalator.active = false;
			bgEscalator.setGraphicSize(Std.int(bgEscalator.width * 1.275));
			...
			bottomBoppers = new FlxSprite(-300, 180);
			...
			var fgSnow:FlxSprite = new FlxSprite(-600, 800).loadGraphic(Paths.image('christmas/fgSnow'));
			fgSnow.active = false;
			fgSnow.setGraphicSize(Std.int(fgSnow.width * 1.5));
		...
		{
			curStage = 'mallEvil';
			var bg:FlxSprite = new FlxSprite(-600, -750).loadGraphic(Paths.image('christmas/evilBG'));
			bg.antialiasing = true;
			bg.scrollFactor.set(0.2, 0.2);
			bg.active = false;
			bg.setGraphicSize(Std.int(bg.width * 1.2));
			...
			var evilTree:FlxSprite = new FlxSprite(450, -450).loadGraphic(Paths.image('christmas/evilTree'));
			evilTree.antialiasing = true;
			evilTree.scrollFactor.set(0.2, 0.2);
			add(evilTree);

			var evilSnow:FlxSprite = new FlxSprite(-200, 800).loadGraphic(Paths.image("christmas/evilSnow"));
		...
		else if (SONG.song.toLowerCase() == 'senpai' || SONG.song.toLowerCase() == 'roses')
		{
		    ...
		    bgSky.setGraphicSize(Std.int(bgSky.width * 1.5));
			add(bgSky);

			var repositionShit = -300;
			...
			var fgTrees:FlxSprite = new FlxSprite(repositionShit + 255, 195).loadGraphic(Paths.image('weeb/weebTreesBack'));
			fgTrees.scrollFactor.set(0.9, 0.9);
			add(fgTrees);

			var bgTrees:FlxSprite = new FlxSprite(repositionShit - 570, -1200);
			...
			var treeLeaves:FlxSprite = new FlxSprite(repositionShit, -60);
		...
		else
		{
			defaultCamZoom = 0.9;
			curStage = 'stage';
			var bg:FlxSprite = new FlxSprite(-900, -300).loadGraphic(Paths.image('stageback'));
			...
			var stageFront:FlxSprite = new FlxSprite(-975, 600).loadGraphic(Paths.image('stagefront'));
			...
			var stageCurtains:FlxSprite = new FlxSprite(-750, -450).loadGraphic(Paths.image('stagecurtains'));
